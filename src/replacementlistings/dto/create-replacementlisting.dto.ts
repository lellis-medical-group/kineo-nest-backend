...
export const CreateReplacementListingSchema = z
  .object({
    ...
    description: z.string().max(2000).optional().describe('Free text details about the replacement'),
    maxApplications: z.number().int().positive().max(100).optional().describe('Optional cap on the number of active applications'),
  })
