...
export const CreatePracticeSchema = z.object({
  ...
  latitude: z.number().min(-90).max(90).optional().describe('Latitude of the practice location'),
  longitude: z.number().min(-180).max(180).optional().describe('Longitude of the practice location'),
