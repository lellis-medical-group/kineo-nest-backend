export function verificationEmailTemplate({
  ...
  const displayName = name ?? "nouvel utilisateur";
  ...
  <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px; width:100%; background-color:#ffffff; border-collapse:collapse;" bgcolor="#ffffff">
    <tr>
      <td style="padding:40px 30px 20px 30px; background-color:#ffffff;">
        <h1 style="font-size:24px; font-weight:600; color:#1a2a3a; margin:0; padding:0;">Bienvenue sur Kinéo !</h1>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td style="padding:30px 30px 20px 30px; color:#2d3748; font-size:16px; line-height:1.6; background-color:#ffffff;">
        ...
        <p style="padding:0 0 15px 0; margin:0;">Merci d’avoir créé un compte. Pour profiter pleinement de nos services, nous devons confirmer que cette adresse email vous appartient bien.</p>
        <p style="padding:0 0 25px 0; margin:0;">Cliquez sur le bouton ci-dessous pour valider votre adresse :</p>

        <!-- Bouton -->
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse; padding:0 0 25px 0;">
          <tr>
            <td align="center" style="background-color:#16a34a; padding:12px 28px;" bgcolor="#16a34a">
              <a href="${url}" style="color:#ffffff; font-weight:600; font-size:16px; text-decoration:none; display:inline-block;">Vérifier mon email</a>
            </td>
          </tr>
        </table>

        <p style="padding:0 0 15px 0; margin:0; font-size:14px; color:#64748b;">Ce lien est valable 24 heures.</p>
        <p style="padding:0 0 5px 0; margin:0; font-size:14px; color:#64748b;">Si vous n’avez pas créé de compte, ignorez cet email.</p>
        <p style="padding:0; margin:0; font-size:14px; color:#64748b;">Nous sommes ravis de vous compter parmi nous !</p>
      </td>
    </tr>
    <tr>
